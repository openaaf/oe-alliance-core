...
SVNDIR = "svn/${PN}"
SRC_URI = "svn://svn.dyndns.tv/svn/ipk/source;module=settings_unitymedia_cable;protocol=http;user=public;pswd=public;externals=allowed"

S = "${UNPACKDIR}/settings_unitymedia_cable"
