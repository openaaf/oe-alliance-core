...
RDEPENDS:titan-plugin-player-tithek = "enigma2-plugin-extensions-e2iplayer-deps curl"
RDEPENDS:titan-plugin-network-xupnpd = "titan-xupnpd titan-bouquet2m3u"
RDEPENDS:titan-plugin-browser-netsurf = "titan-netsurf"
