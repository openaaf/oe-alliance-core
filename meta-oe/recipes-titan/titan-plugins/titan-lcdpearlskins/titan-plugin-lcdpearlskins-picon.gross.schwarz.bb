...
SVNDIR = "svn/${PN}"
SRC_URI = "svn://svn.dyndns.tv/svn/ipk/source;module=lcdpearlskins_picon_gross_schwarz;protocol=http;user=public;pswd=public;externals=allowed"

S = "${UNPACKDIR}/lcdpearlskins_picon_gross_schwarz"
