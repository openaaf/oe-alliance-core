SUMMARY = "LCD Pearl Skins for Titan"
MAINTAINER = "TitanNit Team"
SECTION = "lcdpearlskins"
#PRIORITY = "optional"
LICENSE = "GPLv2"
...
SVNDIR = "svn/${PN}"
SRC_URI = "svn://svn.dyndns.tv/svn/ipk/source;module=lcdpearlskins_schwarz_ohne_picons;protocol=http;user=public;pswd=public;externals=allowed"

S = "${UNPACKDIR}/lcdpearlskins_schwarz_ohne_picons"
