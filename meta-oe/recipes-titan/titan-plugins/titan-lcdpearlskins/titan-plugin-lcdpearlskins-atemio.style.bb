...
SVNDIR = "svn/${PN}"
SRC_URI = "svn://svn.dyndns.tv/svn/ipk/source;module=lcdpearlskins_atemio_style;protocol=http;user=public;pswd=public;externals=allowed"

S = "${UNPACKDIR}/lcdpearlskins_atemio_style"
