...
SVNDIR = "svn/${PN}"
SRC_URI = "svn://svn.dyndns.tv/svn/ipk/source.arm;module=playersnp_codecpack;protocol=http;user=public;pswd=public;externals=allowed"

S = "${UNPACKDIR}/playersnp_codecpack"
