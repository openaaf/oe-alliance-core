...
#EXTRA_OECMAKE:arm += " -DOSCAM_SYSTEM_NAME=FriendlyARM -DOSCAM_SYSTEM_NAME=FriendlyARM -DHAVE_LIBDVBCSA=1 -DSTATIC_LIBDVBCSA=1 -DWITH_EMU=0 -DWITH_ARM_NEON=1"
#EXTRA_OECMAKE:mipsel += " -DOSCAM_SYSTEM_NAME=FriendlyMIPSEL -DOSCAM_SYSTEM_NAME=FriendlyARM -DHAVE_LIBDVBCSA=1 -DSTATIC_LIBDVBCSA=1 -DWITH_EMU=0 "
#EXTRA_OECMAKE:sh4 += " -DOSCAM_SYSTEM_NAME=FriendlySH4 -DOSCAM_SYSTEM_NAME=FriendlyARM -DHAVE_LIBDVBCSA=1 -DSTATIC_LIBDVBCSA=1 -DWITH_EMU=0 "

EXTRA_OECMAKE:arm += " -DOSCAM_SYSTEM_NAME=FriendlyARM -DWITH_ARM_NEON=1"
EXTRA_OECMAKE:mipsel += " -DOSCAM_SYSTEM_NAME=FriendlyMIPSEL -DWITH_ARM_NEON=0"
EXTRA_OECMAKE:sh4 += " -DOSCAM_SYSTEM_NAME=FriendlySH4 -DWITH_ARM_NEON=0 "
