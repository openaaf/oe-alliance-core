...
SVNDIR = "svn/${PN}"
SRC_URI = "svn://svn.dyndns.tv/svn/ipk/source;module=fonts_lydianbolditalicbt_1_0;protocol=http;user=public;pswd=public;externals=allowed"

S = "${UNPACKDIR}/fonts_lydianbolditalicbt_1_0"
...
do_install() {
    ...
    cp -a _path_/usr/share/fonts ${D}/usr/share
