...
SVNDIR = "svn/${PN}"
SRC_URI = "svn://svn.dyndns.tv/svn/ipk/source;module=fonts_digifaceregular_1_0;protocol=http;user=public;pswd=public;externals=allowed"

S = "${UNPACKDIR}/fonts_digifaceregular_1_0"
