...
#		ACTION="add"
		usemount=2
echo 2LABEL: $ID_FS_LABEL >>$LOG
echo 2FSTYPE: $ID_FS_TYPE >>$LOG
		...
		if [ "$1" == "cryptsetup" ]; then
			...
			if [ "$FSTYPE" == "crypto_LUKS" ]; then
				[ ! -e /home/root/logs ] && mkdir /home/root/logs
				echo "/usr/sbin/cryptsetup --debug --key-file /mnt/crypt/partid/$PARTUUID -S 3 luksOpen /dev/$MDEV $MDEV" >>/home/root/logs/crypt.log
				/usr/sbin/cryptsetup --debug --key-file /mnt/crypt/partid/$PARTUUID -S 3 luksOpen /dev/$MDEV $MDEV >>/home/root/logs/crypt.log 2>&1
				echo "############################" >>/home/root/logs/crypt.log
			fi
		else
...
echo 1LABEL: $LABEL >>$LOG
echo 1FSTYPE: $FSTYPE >>$LOG
...
echo 2LABEL: $LABEL >>$LOG
echo 2FSTYPE: $FSTYPE >>$LOG
			...
			if [ "$usemount" == "1" ];then
				if [ "$FSTYPE" == "ext2" ] || [ "$FSTYPE" == "ext3" ] || [ "$FSTYPE" == "ext4" ] || [ "$FSTYPE" == "xfs" ] || [ "$FSTYPE" == "jfs" ]; then
					...
					echo "/sbin/fsck.$FSTYPE -f -p ${DEVDIR}/${MDEV} ACTION=$ACTION 1=$1 2=$2" >>/home/root/logs/fsck.log
					/sbin/fsck.$FSTYPE -f -p ${DEVDIR}/${MDEV} >>/home/root/logs/fsck.log 2>&1
					echo "############################" >>/home/root/logs/fsck.log
				fi
...
#				/etc/init.d/autofs start >>/home/root/logs/autofs.log 2>&1
...
#[ ! -e /home/root/logs ] && mkdir /home/root/logs
#echo 1. ls -al /media/autofs/${MISCNAMEEXTRA}${MDEV}/swapextensions >>/home/root/logs/swapextensions.log 2>&1
#ls -al /media/autofs/${MISCNAMEEXTRA}${MDEV}/swapextensions >>/home/root/logs/swapextensions.log 2>&1
#cat /media/.swapextensionsdev >>/home/root/logs/swapextensions.log 2>&1

#echo 1. ls -al /media/autofs/${MISCNAMEEXTRA}${MDEV}/backup >>/home/root/logs/backup.log 2>&1
#ls -al /media/autofs/${MISCNAMEEXTRA}${MDEV}/backup >>/home/root/logs/backup.log 2>&1
#cat /media/.backupdev >>/home/root/logs/backup.log 2>&1


#echo 2. ls -al /media/autofs/${MISCNAMEEXTRA}${MDEV}/backup >>/home/root/logs/swapextensions.log 2>&1
#ls -al /media/autofs/${MISCNAMEEXTRA}${MDEV}/backup >>/home/root/logs/swapextensions.log 2>&1
#cat /media/.swapextensionsdev >>/home/root/logs/swapextensions.log 2>&1

#echo 2. ls -al /media/autofs/${MISCNAMEEXTRA}${MDEV}/backup >>/home/root/logs/backup.log 2>&1
#ls -al /media/autofs/${MISCNAMEEXTRA}${MDEV}/backup >>/home/root/logs/backup.log 2>&1
#cat /media/.backupdev >>/home/root/logs/backup.log 2>&1
