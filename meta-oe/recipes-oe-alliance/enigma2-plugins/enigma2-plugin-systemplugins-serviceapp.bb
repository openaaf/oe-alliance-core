...
RDEPENDS:${PN} = "enigma2 uchardet openssl exteplayer3 gstplayer2 python3-json"
...
SRC_URI:openaaf = "git://github.com/oe-mirrors/serviceapp.git;branch=openATV;protocol=https"
...
CXXFLAGS += "${@bb.utils.contains_any("DISTRO_NAME", "openatv openaaf openspa openvix openbh teamblue opendroid", "" , " -std=c++11", d)}"
