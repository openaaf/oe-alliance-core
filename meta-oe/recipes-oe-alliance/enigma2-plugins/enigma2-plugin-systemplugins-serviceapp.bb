...
SRC_URI:openaaf = "git://github.com/oe-mirrors/serviceapp.git;branch=sig3;protocol=https"
...
CXXFLAGS += "${@bb.utils.contains_any("DISTRO_NAME", "openaaf openatv openvix openbh teamblue opendroid", "" , " -std=c++11", d)}"
