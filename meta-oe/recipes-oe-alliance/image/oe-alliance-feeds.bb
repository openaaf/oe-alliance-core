...
RDEPENDS:${PN} = " \
    ...
    ${@bb.utils.contains_any("DISTRO_NAME", "openvix openbh openatv openaaf", "", "enigma2-plugin-extensions-ondemand", d)} \
...
STATIC_FEED_BUILD = "\
    ...
    ${@bb.utils.contains("MACHINE_FEATURES", "qthbbtv", "enigma2-plugin-extensions-hbbtv-qt libxml2-qt", "", d)} \
